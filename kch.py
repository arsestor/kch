...
st.caption('Данное веб-приложение является практической частью проекта команды г. Озерск шк. 32 на тему: “Искусственный интеллект в атомной отрасли”, разработанное для участия в конкурсе учебно-исследовательских работ Курчатовские Чтения 2023')
