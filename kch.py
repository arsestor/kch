...
st.header('Данное веб-приложение является практической частью проекта команды г. Озерск шк. 32 на тему: “Искусственный интеллект в атомной отрасли”, разработанное для участия в конкурсе учебно-исследовательских работ Курчатовские Чтения 2023')
st.subheader('Зачастую, сообщения от местных жителей в социальных сетях появляются раньше, чем официальные запросы в спасательные центры')
st.subheader('Если мы сможем определять, в каких из сообщений говорится о событии-катастрофе, исключая нерелевантные, например, сообщения о фильмах, мы сможем ускорить уведомление экстренных служб о чрезвычайных ситуациях и ускорить необходимую помощь')
st.subheader('Подобные задачи эффективно решаются с помощью ИИ с применением машинного обучения. В нашем конкретном случае, реализация выполнена на основе методов обработки естественного языка, или NLP (Natural Language Processing) — одного из направлений искусственного интеллекта, которое работает с анализом, пониманием и генерацией живых языков')
st.subheader('Ядром приложения является обученная модель, которая определяет являются ли введенное сообщение действительно сообщением об угрозе или нет.')
st.subheader('Ниже, в поле ввода вы можете ввести сообщение и приложение сообщит является ли оно сообщением о ЧС.')
